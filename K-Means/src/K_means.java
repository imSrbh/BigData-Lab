...
public class K_means {
    ...
    public static String CENTROID_FILE_NAME = "/kmeans_centroid.txt";
    public static String OUTPUT_FILE_NAME = "/part-00000";
    public static String DATA_FILE_NAME = "/kmeans_data.txt";
    ...
    public static void run(String[] args) throws Exception {
        IN = "/home/skrj/KmeansInput";
        OUT = "/home/skrj/output_kmeans";
        String input = IN;
